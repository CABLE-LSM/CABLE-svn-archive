...
if [ -z $vegfile ]; then
  vegfile='def_veg_params_Ticket2_with_medlyn_litter.txt'
...
in_path="/g/data1/w35/amu561/Rainfall_assymmetry/Inputs"
...
&cable
   ...
   filename%gw_elev = "" ! ${in_path}/GSWP3_elevation_slope_mean_stddev.nc"
