...
host_mael()
{
   ...
   #export CFLAGS='-g -p  -fno-inline-functions '   #-traceback
   #export CFLAGS='-O2 -g -p  -fno-inline-functions  -profile-functions -profile-loops=all -profile-loops-report=2 '   #-traceback
   export CFLAGS='-O2 '
#-g -qopt-report-phase=pgo'  
   if [[ $1 = 'debug' ]]; then
      export CFLAGS='-O0 -traceback -g -fp-model precise -ftz -fpe0 ' 
   fi
   export LD='-lnetcdf -lnetcdff'
