...
SUBROUTINE dryLeaf( dels, rad, rough, air, met,                                &
   ...
   DO WHILE (k < C%MAXITER)
      ...
      WRITE(6,*) 'CABLE : START ITER ', k, ' : MAXVAL(tlfx) = ', MAXVAL(tlfx)
      WRITE(6,*) 'CABLE : START ITER ', k, ' : MINVAL(tlfx) = ', MINVAL(tlfx)
      WRITE(6,*) 'CABLE : START ITER ', k, ' : MAXLOC(tlfx) = ', MAXLOC(tlfx)
      WRITE(6,*) 'CABLE : START ITER ', k, ' : MINLOC(tlfx) = ', MINLOC(tlfx)
      WRITE(6,*) 'CABLE : START ITER ', k, ' : MAXVAL(canopy%fevc) = ', MAXVAL(canopy%fevc)
      WRITE(6,*) 'CABLE : START ITER ', k, ' : MINVAL(canopy%fevc) = ', MINVAL(canopy%fevc)
      WRITE(6,*) 'CABLE : START ITER ', k, ' : MAXLOC(canopy%fevc) = ', MAXLOC(canopy%fevc)
      WRITE(6,*) 'CABLE : START ITER ', k, ' : MINLOC(canopy%fevc) = ', MINLOC(canopy%fevc)
      FLUSH(6)
      ...
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(tlfx) = ', MAXVAL(tlfx)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(tlfx) = ', MINVAL(tlfx)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(tlfx) = ', MAXLOC(tlfx)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(tlfx) = ', MINLOC(tlfx)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(air%dsatdk) = ', MAXVAL(air%dsatdk)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(air%dsatdk) = ', MINVAL(air%dsatdk)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(air%dsatdk) = ', MAXLOC(air%dsatdk)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(air%dsatdk) = ', MINLOC(air%dsatdk)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(rad%rniso) = ', MAXVAL(rad%rniso)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(rad%rniso) = ', MINVAL(rad%rniso)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(rad%rniso) = ', MAXLOC(rad%rniso)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(rad%rniso) = ', MINLOC(rad%rniso)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(met%tvair) = ', MAXVAL(met%tvair)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(met%tvair) = ', MINVAL(met%tvair)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(met%tvair) = ', MAXLOC(met%tvair)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(met%tvair) = ', MINLOC(met%tvair)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(met%tk) = ', MAXVAL(met%tk)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(met%tk) = ', MINVAL(met%tk)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(met%tk) = ', MAXLOC(met%tk)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(met%tk) = ', MINLOC(met%tk)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(rad%gradis) = ', MAXVAL(rad%gradis)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(rad%gradis) = ', MINVAL(rad%gradis)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(rad%gradis) = ', MAXLOC(rad%gradis)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(rad%gradis) = ', MINLOC(rad%gradis)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(met%dva) = ', MAXVAL(met%dva)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(met%dva) = ', MINVAL(met%dva)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(met%dva) = ', MAXLOC(met%dva)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(met%dva) = ', MINLOC(met%dva)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(ghr) = ', MAXVAL(ghr)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(ghr) = ', MINVAL(ghr)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(ghr) = ', MAXLOC(ghr)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(ghr) = ', MINLOC(ghr)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(psycst) = ', MAXVAL(psycst)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(psycst) = ', MINVAL(psycst)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(psycst) = ', MAXLOC(psycst)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(psycst) = ', MINLOC(psycst)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(veg%froot) = ', MAXVAL(veg%froot)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(veg%froot) = ', MINVAL(veg%froot)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(veg%froot) = ', MAXLOC(veg%froot)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(veg%froot) = ', MINLOC(veg%froot)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(ssnow%wb) = ', MAXVAL(ssnow%wb)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(ssnow%wb) = ', MINVAL(ssnow%wb)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(ssnow%wb) = ', MAXLOC(ssnow%wb)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(ssnow%wb) = ', MINLOC(ssnow%wb)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(soil%swilt) = ', MAXVAL(soil%swilt)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(soil%swilt) = ', MINVAL(soil%swilt)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(soil%swilt) = ', MAXLOC(soil%swilt)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(soil%swilt) = ', MINLOC(soil%swilt)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXVAL(soil%zse) = ', MAXVAL(soil%zse)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINVAL(soil%zse) = ', MINVAL(soil%zse)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MAXLOC(soil%zse) = ', MAXLOC(soil%zse)
      WRITE(6,*) 'CABLE : END ITER ', k, ' : MINLOC(soil%zse) = ', MINLOC(soil%zse)
      FLUSH(6)
