...
MODULE cable_output_module
  ...
  TYPE out_varID_type ! output variable IDs in netcdf file
    INTEGER ::      SWdown, LWdown, Wind, Wind_E, PSurf,                       &
                    ...
                    Qs, Qsb, Evap, PotEvap, BaresoilT, SWE, SnowT,Gs,          & ! MMY@June2023 add PotEvap and Gs
...
CONTAINS
  ...
  SUBROUTINE open_output_file(dels, soil, veg, bgc, rough)
    ...
    END IF
    ! ____________________ MMY@June2023 ____________________
...
!! vh_js !!
    ...
    IF(output%flux .OR. output%Evap) THEN
       ...
       END IF
    END IF
    ! ___________________ MMY@June2023 _______________________
