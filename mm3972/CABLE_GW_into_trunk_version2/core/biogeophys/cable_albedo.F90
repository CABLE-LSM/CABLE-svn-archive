...
!$    WHERE (soil%isoilm == 9)       ! use dry snow albedo   ! This bit appears instead in MYY code --rk4417 ! MMY@23Apr2023 keep this comments since future may need to review it 
