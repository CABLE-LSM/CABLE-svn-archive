...
!$  The line above appears uncommented in MMY code -- rk4417   ! MMY@23Apr2023  need to check with Claire
    ...
    IF (cable_runtime%um) THEN
      ...
      !$       The line above is different in MMY code -- rk4417 ! MMY@23Apr2023 below commented is from CABLE-GW, need to check with Claire
      ! rad%trad = ( ( 1.-rad%transd ) * C%emleaf * canopy%tv**4 +                     & 
