...
!$  INTEGER, PARAMETER :: nparam = 330    !  replaced line by block below as per MMY code -- rk4417 ! MMY@23Apr2023 delete this line as CABLE-GW has more iovars
  ...
  ! MPI: CABLE_r491, after following up with Bernard on the new variables
  ! vh sli nmat + 4 36 -> 40
!$  INTEGER, PARAMETER :: nmat = 40   ! replaced line by one below as per MMY code -- rk4417 ! MMY@23Apr2023 delete this line as CABLE-GW has more iovars
...
!$  INTEGER, PARAMETER :: nvec = 175    ! replaced line by one below as per MMY code -- rk4417 ! MMY@23Apr2023 delete this line as CABLE-GW has more iovars
