...
!$       DO x=1,xdimsize       ! this loop replaces the else part in MMY code -- rk4417 ! MMY@23Apr2023 delete these three lines since the below codes are more efficient
...
!$       DO y=1,ydimsize    ! this loop replaces the else part in MMY code -- rk4417 ! MMY@23Apr2023 delete these three lines since the below codes are more efficient
