...
MODULE cable_checks_module
  ...
  TYPE ranges_type
     REAL, DIMENSION(2) ::                                               &
          ...
          PAR = (/-1000.0,5000.0/),           & ! umol/m2/s  ! this line is absent from MMY code -- rk4417  ! MMY@23Apr2023 keep this line and delete the comment
          ...
          hyds = (/5.0E-7,8.5E-3/),           & ! vh_js ! sep14 ! replaced this line as per MMY -- rk4417 ! MMY@23Apr2023 delete the comment
          ! hyds = (/5.0E-7,8.5/),              & ! vh_js ! sep14 ! MMY ! MMY@23Apr2023 delete this line
          ...
          silt = (/0.0,1.0/),                 &
          ssat = (/0.35,0.5/),                &
!$          sucs = (/-0.8,-0.03/),              &   ! replaced this line as per MMY -- rk4417 ! MMY@23Apr2023 keep this line commented since it works for CABLE-non GW 
