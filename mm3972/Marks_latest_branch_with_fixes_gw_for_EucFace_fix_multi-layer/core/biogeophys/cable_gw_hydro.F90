...
SUBROUTINE GWsoilfreeze(dels, soil, ssnow)
  ...
  ! if max_ice_frac always set to frozen_limit and tgg_tmp is always C%TFRZ
   ...
   REAL(r_2),DIMENSION(mp,ms) :: xx,max_ice_frac,den_css  !Decker and Zeng 2009 ! MMY iceF,
...
SUBROUTINE calc_soil_hydraulic_props(ssnow,soil,veg)
   ...
   ! _______________ MMY COMMENT: for Hutson Cass SWC potential _______________
   do k=1,ms
      do i=1,mp
