...
!    vegin%clitt(11) =        2.000000
 ...
 !=========================================================
   vegin%canst1(11) =        0.100000
   vegin%length(11) =        0.055000
    vegin%width(11) =        0.001000
    vegin%vcmax(11) =        0.000040
    vegin%ejmax(11) =        0.000000
       vegin%hc(11) =       17.000000
    vegin%xfang(11) =        0.010000
     vegin%rp20(11) =        3.000000
   vegin%rpcoef(11) =        0.083200
     vegin%rs20(11) =        1.000000
      vegin%wai(11) =        1.000000
 vegin%rootbeta(11) =        0.943000
   vegin%shelrb(11) =        2.000000
    vegin%vegcf(11) =        9.000000
    vegin%frac4(11) =        0.000000
  vegin%xalbnir(11) =        1.000000
    vegin%extkn(11) =        0.001000
   vegin%tminvj(11) =      -15.000000
   vegin%tmaxvj(11) =      -10.000000
    vegin%vbeta(11) =        2.000000
    vegin%froot(1,11) =        0.050000
    vegin%froot(2,11) =        0.050000
    vegin%froot(3,11) =        0.050000
    vegin%froot(4,11) =        0.050000
    vegin%froot(5,11) =        0.050000
    vegin%froot(6,11) =        0.050000
     vegin%refl(1,11) =        0.090000
     vegin%taul(1,11) =        0.090000
     vegin%refl(2,11) =        0.300000
     vegin%taul(2,11) =        0.300000
     vegin%refl(3,11) =        0.010000
     vegin%taul(3,11) =        0.010000
    vegin%csoil(1,11) =      184.000000
   vegin%ratecs(1,11) =        2.000000
    vegin%csoil(2,11) =      367.000000
   vegin%ratecs(2,11) =        0.500000
   vegin%cplant(1,11) =      200.000000
   vegin%ratecp(1,11) =        1.000000
   vegin%cplant(2,11) =    10217.000000
   vegin%ratecp(2,11) =        0.030000
   vegin%cplant(3,11) =      876.000000
   vegin%ratecp(3,11) =        0.140000
     vegin%a1gs(11) =        9.000000
     vegin%d0gs(11) =     1500.000000
    vegin%alpha(11) =        0.200000
   ...
   vegin%conko0(11) =        0.256000
      ...
      vegin%eko(11) =    36000.000000
       vegin%g0(11) =        0.000000
       vegin%g1(11) =        2.346064
       vegin%zr(11) =        1.800000
    vegin%clitt(11) =       20.000000
 ...
 !=========================================================
    vegin%canst1(12) =        0.100000
   vegin%length(12) =        0.100000
    vegin%width(12) =        0.050000
    vegin%vcmax(12) =        0.000055
    vegin%ejmax(12) =        0.000000
       vegin%hc(12) =       35.000000
    vegin%xfang(12) =        0.100000
     vegin%rp20(12) =        0.600000
   vegin%rpcoef(12) =        0.083200
     vegin%rs20(12) =        1.000000
      vegin%wai(12) =        1.000000
 vegin%rootbeta(12) =        0.962000
   vegin%shelrb(12) =        2.000000
    vegin%vegcf(12) =       14.000000
    vegin%frac4(12) =        0.000000
  vegin%xalbnir(12) =        1.000000
    vegin%extkn(12) =        0.001000
   vegin%tminvj(12) =      -15.000000
   vegin%tmaxvj(12) =      -10.000000
    vegin%vbeta(12) =        2.000000
    vegin%froot(1,12) =        0.200000
    vegin%froot(2,12) =        0.200000
    vegin%froot(3,12) =        0.200000
    vegin%froot(4,12) =        0.200000
    vegin%froot(5,12) =        0.200000
    vegin%froot(6,12) =        0.200000
     vegin%refl(1,12) =        0.090000
     vegin%taul(1,12) =        0.090000
     vegin%refl(2,12) =        0.290000
     vegin%taul(2,12) =        0.290000
     vegin%refl(3,12) =        0.010000
     vegin%taul(3,12) =        0.010000
    vegin%csoil(1,12) =      303.000000
   vegin%ratecs(1,12) =        2.000000
    vegin%csoil(2,12) =      606.000000
   vegin%ratecs(2,12) =        0.500000
   vegin%cplant(1,12) =      300.000000
   vegin%ratecp(1,12) =        1.000000
   vegin%cplant(2,12) =    16833.000000
   vegin%ratecp(2,12) =        0.030000
   vegin%cplant(3,12) =     1443.000000
   vegin%ratecp(3,12) =        0.140000
     vegin%a1gs(12) =        9.000000
     vegin%d0gs(12) =     1500.000000
    vegin%alpha(12) =        0.200000
   ...
   vegin%conko0(12) =        0.256000
      ...
      vegin%eko(12) =    36000.000000
       vegin%g0(12) =        0.000000
       vegin%g1(12) =        4.114762
       vegin%zr(12) =        3.000000
    vegin%clitt(12) =        6.000000
...
!    vegin%clitt(13) =        0.000000
 ...
 !=========================================================
    vegin%canst1(13) =        0.100000
   vegin%length(13) =        0.150000
    vegin%width(13) =        0.080000
    vegin%vcmax(13) =        0.000060
    vegin%ejmax(13) =        0.000000
       vegin%hc(13) =       20.000000
    vegin%xfang(13) =        0.250000
     vegin%rp20(13) =        2.200000
   vegin%rpcoef(13) =        0.083200
     vegin%rs20(13) =        1.000000
      vegin%wai(13) =        1.000000
 vegin%rootbeta(13) =        0.961000
   vegin%shelrb(13) =        2.000000
    vegin%vegcf(13) =        8.000000
    vegin%frac4(13) =        0.000000
  vegin%xalbnir(13) =        1.000000
    vegin%extkn(13) =        0.001000
   vegin%tminvj(13) =        5.000000
   vegin%tmaxvj(13) =       15.000000
    vegin%vbeta(13) =        2.000000
    vegin%froot(1,13) =        0.200000
    vegin%froot(2,13) =        0.200000
    vegin%froot(3,13) =        0.200000
    vegin%froot(4,13) =        0.200000
    vegin%froot(5,13) =        0.200000
    vegin%froot(6,13) =        0.200000
     vegin%refl(1,13) =        0.090000
     vegin%taul(1,13) =        0.090000
     vegin%refl(2,13) =        0.290000
     vegin%taul(2,13) =        0.290000
     vegin%refl(3,13) =        0.010000
     vegin%taul(3,13) =        0.010000
    vegin%csoil(1,13) =      216.000000
   vegin%ratecs(1,13) =        2.000000
    vegin%csoil(2,13) =      432.000000
   vegin%ratecs(2,13) =        0.500000
   vegin%cplant(1,13) =      300.000000
   vegin%ratecp(1,13) =        1.000000
   vegin%cplant(2,13) =    12000.000000
   vegin%ratecp(2,13) =        0.030000
   vegin%cplant(3,13) =     1029.000000
   vegin%ratecp(3,13) =        0.140000
     vegin%a1gs(13) =        9.000000
     vegin%d0gs(13) =     1500.000000
    vegin%alpha(13) =        0.200000
   ...
   vegin%conko0(13) =        0.256000
      ...
      vegin%eko(13) =    36000.000000
       vegin%g0(13) =        0.000000
       vegin%g1(13) =        4.447321
       vegin%zr(13) =        2.000000
    vegin%clitt(13) =       13.000000
