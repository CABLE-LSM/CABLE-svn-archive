...
!    vegin%clitt(11) =        2.000000
 ...
 !PFT: secondary evergreen_needleleaf                                                  
 !=========================================================
   vegin%canst1(11)   =     vegin%canst1(1)
   vegin%length(11)   =     vegin%length(1)
    vegin%width(11)   =      vegin%width(1)
    vegin%vcmax(11)   =      vegin%vcmax(1)
    vegin%ejmax(11)   =      vegin%ejmax(1)
       vegin%hc(11)   =         vegin%hc(1)
    vegin%xfang(11)   =      vegin%xfang(1)
     vegin%rp20(11)   =       vegin%rp20(1)
   vegin%rpcoef(11)   =     vegin%rpcoef(1) 
     vegin%rs20(11)   =       vegin%rs20(1) 
      vegin%wai(11)   =        vegin%wai(1) 
 vegin%rootbeta(11)   =   vegin%rootbeta(1) 
   vegin%shelrb(11)   =     vegin%shelrb(1) 
    vegin%vegcf(11)   =      vegin%vegcf(1) 
    vegin%frac4(11)   =      vegin%frac4(1) 
  vegin%xalbnir(11)   =    vegin%xalbnir(1) 
    vegin%extkn(11)   =      vegin%extkn(1) 
   vegin%tminvj(11)   =     vegin%tminvj(1) 
   vegin%tmaxvj(11)   =     vegin%tmaxvj(1) 
    vegin%vbeta(11)   =      vegin%vbeta(1) 
    vegin%froot(1,11) =    vegin%froot(1,1) 
    vegin%froot(2,11) =    vegin%froot(2,1) 
    vegin%froot(3,11) =    vegin%froot(3,1) 
    vegin%froot(4,11) =    vegin%froot(4,1) 
    vegin%froot(5,11) =    vegin%froot(5,1) 
    vegin%froot(6,11) =    vegin%froot(6,1) 
     vegin%refl(1,11) =     vegin%refl(1,1) 
     vegin%taul(1,11) =     vegin%taul(1,1) 
     vegin%refl(2,11) =     vegin%refl(2,1) 
     vegin%taul(2,11) =     vegin%taul(2,1) 
     vegin%refl(3,11) =     vegin%refl(3,1) 
     vegin%taul(3,11) =     vegin%taul(3,1) 
    vegin%csoil(1,11) =    vegin%csoil(1,1) 
   vegin%ratecs(1,11) =   vegin%ratecs(1,1) 
    vegin%csoil(2,11) =    vegin%csoil(2,1) 
   vegin%ratecs(2,11) =   vegin%ratecs(2,1) 
   vegin%cplant(1,11) =   vegin%cplant(1,1) 
   vegin%ratecp(1,11) =   vegin%ratecp(1,1) 
   vegin%cplant(2,11) =   vegin%cplant(2,1) 
   vegin%ratecp(2,11) =   vegin%ratecp(2,1) 
   vegin%cplant(3,11) =   vegin%cplant(3,1) 
   vegin%ratecp(3,11) =   vegin%ratecp(3,1) 
     vegin%a1gs(11)   =       vegin%a1gs(1) 
     vegin%d0gs(11)   =       vegin%d0gs(1) 
    vegin%alpha(11)   =      vegin%alpha(1) 
   vegin%convex(11)   =     vegin%convex(1) 
     vegin%cfrd(11)   =       vegin%cfrd(1) 
   vegin%gswmin(11)   =     vegin%gswmin(1) 
   vegin%conkc0(11)   =     vegin%conkc0(1) 
   vegin%conko0(11)   =     vegin%conko0(1) 
      vegin%ekc(11)   =        vegin%ekc(1) 
      vegin%eko(11)   =        vegin%eko(1) 
       vegin%g0(11)   =         vegin%g0(1) 
       vegin%g1(11)   =         vegin%g1(1) 
       vegin%zr(11)   =         vegin%zr(1) 
    vegin%clitt(11)   =      vegin%clitt(1) 
 ...
 !PFT: secondary evergreen_broadleaf                                                   
 !=========================================================
   vegin%canst1(12)   =     vegin%canst1(2)
   vegin%length(12)   =     vegin%length(2)
    vegin%width(12)   =      vegin%width(2)
    vegin%vcmax(12)   =      vegin%vcmax(2)
    vegin%ejmax(12)   =      vegin%ejmax(2)
       vegin%hc(12)   =         vegin%hc(2)
    vegin%xfang(12)   =      vegin%xfang(2)
     vegin%rp20(12)   =       vegin%rp20(2)
   vegin%rpcoef(12)   =     vegin%rpcoef(2) 
     vegin%rs20(12)   =       vegin%rs20(2) 
      vegin%wai(12)   =        vegin%wai(2) 
 vegin%rootbeta(12)   =   vegin%rootbeta(2) 
   vegin%shelrb(12)   =     vegin%shelrb(2) 
    vegin%vegcf(12)   =      vegin%vegcf(2) 
    vegin%frac4(12)   =      vegin%frac4(2) 
  vegin%xalbnir(12)   =    vegin%xalbnir(2) 
    vegin%extkn(12)   =      vegin%extkn(2) 
   vegin%tminvj(12)   =     vegin%tminvj(2) 
   vegin%tmaxvj(12)   =     vegin%tmaxvj(2) 
    vegin%vbeta(12)   =      vegin%vbeta(2) 
    vegin%froot(1,12) =    vegin%froot(1,2) 
    vegin%froot(2,12) =    vegin%froot(2,2) 
    vegin%froot(3,12) =    vegin%froot(3,2) 
    vegin%froot(4,12) =    vegin%froot(4,2) 
    vegin%froot(5,12) =    vegin%froot(5,2) 
    vegin%froot(6,12) =    vegin%froot(6,2) 
     vegin%refl(1,12) =     vegin%refl(1,2) 
     vegin%taul(1,12) =     vegin%taul(1,2) 
     vegin%refl(2,12) =     vegin%refl(2,2) 
     vegin%taul(2,12) =     vegin%taul(2,2) 
     vegin%refl(3,12) =     vegin%refl(3,2) 
     vegin%taul(3,12) =     vegin%taul(3,2) 
    vegin%csoil(1,12) =    vegin%csoil(1,2) 
   vegin%ratecs(1,12) =   vegin%ratecs(1,2) 
    vegin%csoil(2,12) =    vegin%csoil(2,2) 
   vegin%ratecs(2,12) =   vegin%ratecs(2,2) 
   vegin%cplant(1,12) =   vegin%cplant(1,2) 
   vegin%ratecp(1,12) =   vegin%ratecp(1,2) 
   vegin%cplant(2,12) =   vegin%cplant(2,2) 
   vegin%ratecp(2,12) =   vegin%ratecp(2,2) 
   vegin%cplant(3,12) =   vegin%cplant(3,2) 
   vegin%ratecp(3,12) =   vegin%ratecp(3,2) 
     vegin%a1gs(12)   =       vegin%a1gs(2) 
     vegin%d0gs(12)   =       vegin%d0gs(2) 
    vegin%alpha(12)   =      vegin%alpha(2) 
   vegin%convex(12)   =     vegin%convex(2) 
     vegin%cfrd(12)   =       vegin%cfrd(2) 
   vegin%gswmin(12)   =     vegin%gswmin(2) 
   vegin%conkc0(12)   =     vegin%conkc0(2) 
   vegin%conko0(12)   =     vegin%conko0(2) 
      vegin%ekc(12)   =        vegin%ekc(2) 
      vegin%eko(12)   =        vegin%eko(2) 
       vegin%g0(12)   =         vegin%g0(2) 
       vegin%g1(12)   =         vegin%g1(2) 
       vegin%zr(12)   =         vegin%zr(2) 
    vegin%clitt(12)   =      vegin%clitt(2) 
...
!    vegin%clitt(13) =        0.000000
 ...
 !PFT: secondary deciduous_broadleaf                                                   
 !=========================================================
   vegin%canst1(13)   =     vegin%canst1(4)
   vegin%length(13)   =     vegin%length(4)
    vegin%width(13)   =      vegin%width(4)
    vegin%vcmax(13)   =      vegin%vcmax(4)
    vegin%ejmax(13)   =      vegin%ejmax(4)
       vegin%hc(13)   =         vegin%hc(4)
    vegin%xfang(13)   =      vegin%xfang(4)
     vegin%rp20(13)   =       vegin%rp20(4)
   vegin%rpcoef(13)   =     vegin%rpcoef(4) 
     vegin%rs20(13)   =       vegin%rs20(4) 
      vegin%wai(13)   =        vegin%wai(4) 
 vegin%rootbeta(13)   =   vegin%rootbeta(4) 
   vegin%shelrb(13)   =     vegin%shelrb(4) 
    vegin%vegcf(13)   =      vegin%vegcf(4) 
    vegin%frac4(13)   =      vegin%frac4(4) 
  vegin%xalbnir(13)   =    vegin%xalbnir(4) 
    vegin%extkn(13)   =      vegin%extkn(4) 
   vegin%tminvj(13)   =     vegin%tminvj(4) 
   vegin%tmaxvj(13)   =     vegin%tmaxvj(4) 
    vegin%vbeta(13)   =      vegin%vbeta(4) 
    vegin%froot(1,13) =    vegin%froot(1,4) 
    vegin%froot(2,13) =    vegin%froot(2,4) 
    vegin%froot(3,13) =    vegin%froot(3,4) 
    vegin%froot(4,13) =    vegin%froot(4,4) 
    vegin%froot(5,13) =    vegin%froot(5,4) 
    vegin%froot(6,13) =    vegin%froot(6,4) 
     vegin%refl(1,13) =     vegin%refl(1,4) 
     vegin%taul(1,13) =     vegin%taul(1,4) 
     vegin%refl(2,13) =     vegin%refl(2,4) 
     vegin%taul(2,13) =     vegin%taul(2,4) 
     vegin%refl(3,13) =     vegin%refl(3,4) 
     vegin%taul(3,13) =     vegin%taul(3,4) 
    vegin%csoil(1,13) =    vegin%csoil(1,4) 
   vegin%ratecs(1,13) =   vegin%ratecs(1,4) 
    vegin%csoil(2,13) =    vegin%csoil(2,4) 
   vegin%ratecs(2,13) =   vegin%ratecs(2,4) 
   vegin%cplant(1,13) =   vegin%cplant(1,4) 
   vegin%ratecp(1,13) =   vegin%ratecp(1,4) 
   vegin%cplant(2,13) =   vegin%cplant(2,4) 
   vegin%ratecp(2,13) =   vegin%ratecp(2,4) 
   vegin%cplant(3,13) =   vegin%cplant(3,4) 
   vegin%ratecp(3,13) =   vegin%ratecp(3,4) 
     vegin%a1gs(13)   =       vegin%a1gs(4) 
     vegin%d0gs(13)   =       vegin%d0gs(4) 
    vegin%alpha(13)   =      vegin%alpha(4) 
   vegin%convex(13)   =     vegin%convex(4) 
     vegin%cfrd(13)   =       vegin%cfrd(4) 
   vegin%gswmin(13)   =     vegin%gswmin(4) 
   vegin%conkc0(13)   =     vegin%conkc0(4) 
   vegin%conko0(13)   =     vegin%conko0(4) 
      vegin%ekc(13)   =        vegin%ekc(4) 
      vegin%eko(13)   =        vegin%eko(4) 
       vegin%g0(13)   =         vegin%g0(4) 
       vegin%g1(13)   =         vegin%g1(4) 
       vegin%zr(13)   =         vegin%zr(4) 
    vegin%clitt(13)   =      vegin%clitt(4) 
