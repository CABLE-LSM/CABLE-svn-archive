...
SUBROUTINE spinanalytic(fcnpspin,dels,kstart,kend,mloop,veg,soil,casabiome,casapool, &
                       casaflux,casamet,casabal,phen)
  USE cable_def_types_mod
  USE cable_carbon_module
  USE casadimension
...
END SUBROUTINE spinanalytic
  ...
  INTEGER  npt,nvt
      ...
      print *, 'totcnppools area =', casamet%areacell(1:10)
      ...
      print *, 'totcnppools bm area =', bmarea
