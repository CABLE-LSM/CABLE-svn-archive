...
SUBROUTINE define_canopy(bal,rad,rough,air,met,dels,ssnow,soil,veg, canopy, bgc)
   ...
   REAL, DIMENSION(:), POINTER ::                                              &
      ...
      fwsoil_ns,     & ! soil water modifier of vcmax, MDK 26 March 2015
   ...
   ! MDK 26 March 2015, allocating fwsoil_ns
   ...
   DO iter = 1, NITER
      ...
      ! MDK 26 March 2015. passing fwsoil_ns and the bgc structure
      ...
      ! Martin De Kauwe, 30 March 2015 - Turn off soil evaporation
      ! Not using this for paper, this was just for testing
   ...
   DEALLOCATE(dsx, fwsoil, fwsoil_ns, tlfx, tlfy) ! MDK 26 March 2015.
...
SUBROUTINE dryLeaf( dels, rad, rough, air, met,                                &
   ...
   ! MDK 26 March 2015, passing C biomass (g C m-2)
   TYPE (bgc_pool_type),  INTENT(INOUT) :: bgc

   REAL, INTENT(INOUT), DIMENSION(:) ::                                        &
      dsx,        & ! leaf surface vpd
      fwsoil,     & ! soil water modifier of stom. cond
      fwsoil_ns,  & ! soil water modifier for vcmax, MDK 26 March 2015.
      tlfx,       & ! leaf temp prev. iter (K)
      tlfy          ! leaf temp (K)
