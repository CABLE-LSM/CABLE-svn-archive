...
known_hosts()
{
   set -A kh  pear jigg nXXX raij ces2 ccrc mael Mart mart
}
host_mart(){
...
host_write()
{
   ...
   print '{' >> junk
   print '   set -A kh' ${kh[*]} $HOST_MACH >> junk ccrc ccrc Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart ccrc ccrc Mart ccrc ccrc ccrc ccrc ccrc ccrc ccrc ccrc Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart mart
   print '}' >> junk
   print '' >> junk
   print '' >> junk
