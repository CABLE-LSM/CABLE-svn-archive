...
host_raij()
{
   ...
   export FC='mpif90'
   export CFLAGS='-fpp -O2 -fp-model precise -fpe0 -g -traceback  -nostand '
   if [[ $1 = 'debug' ]]; then
      export CFLAGS='-fpp -O0 -fp-model precise -fpe0 -g -traceback  -nostand -check all,noarg_temp_created -debug all' 
   fi
