...
for(site in 1:length(obsfiles)) { # for each site
   ...
   cnlist[7] = '  filename%LAI     = \'./MCDlai_Mk3L.nc\''
#jhan:orig
#   cnlist[8] = '  filename%type    = \'../data/surface_data/VegSoil_Type_Global_igbp.csv\''
    cnlist[8] = '  filename%type    = \'../data/surface_data/tmp.nc\''
   cnlist[9] = '  filename%veg     = \'../data/surface_data/def_veg_params_igbp.txt\''
   cnlist[10] = '  filename%soil    = \'../data/surface_data/def_soil_params.txt\''
   ...
   cnlist[25] = '  check%ranges     = .TRUE.  ! variable ranges, input and output' # not for LittleWashita
   ...
   cnlist[31] = '  fixedCO2 = 350.0   ! if not found in met file, in ppmv'
    ...
    cnlist[41] = '  cable_user%FWSOIL_SWITCH = \'standard\'        ! choices are: ' 
    cnlist[42] = '                                                ! 1. standard ' 
    cnlist[43] = '                                                ! 2. non-linear extrapolation '
    cnlist[44] = '                                                ! 3. Lai and Ktaul 2000 '
    cnlist[45] = '  cable_user%DIAG_SOIL_RESP = \'ON \' ' 
    cnlist[46] = '  cable_user%LEAF_RESPIRATION = \'ON \' ' 

    cnlist[47] = '  cable_user%RUN_DIAG_LEVEL= \'BASIC\'        ! choices are: ' 
    cnlist[48] = '                                                ! 1. BASIC' 
    cnlist[49] = '                                                ! 1. NONE' 
