...
for(site in 1:length(obsfiles)) { # for each site
   ...
   #cnlist[5] = '  filename%restart_in  = \'data/restart_out.nc \''
   ...
   cnlist[38] = 'casafile%cnpbiome=\'../../core/pkg/CASA/data/pftlookup_csiro_v16_17tiles.csv\'  ! biome specific BGC parameters'
   ...
   cnlist[43] = '  casafile%phen=\'../../core/pkg/CASA/data/modis_phenology_csiro.txt\'        ! modis phenology'
   ...
   cnlist[69] = '  cable_user%SSOIL_POTEV= \'HDM\'      ! Humidity Deficit Method' 
