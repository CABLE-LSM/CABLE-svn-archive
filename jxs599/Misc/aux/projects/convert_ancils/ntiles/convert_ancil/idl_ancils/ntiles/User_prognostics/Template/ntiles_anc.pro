...
pro    ntiles_anc, filein, fileout, ntiles, nlat, nlon, $
            ...
            temphistout,cfi1out,cfi2out,cfi3out,lookupout,data, npft, oldntiles 
   ...
   rewritedata, datain, data, nrec, ntiles, nlat, nlon, npft, oldntiles
...
;   
   ...
   wrancil, fileout, fixhdrout,intcout,realcout,levdepcout,rowdepcout, $
          ...
          cfi3out,lookupout, data, ntiles, /swap;, /makewellformed
end
