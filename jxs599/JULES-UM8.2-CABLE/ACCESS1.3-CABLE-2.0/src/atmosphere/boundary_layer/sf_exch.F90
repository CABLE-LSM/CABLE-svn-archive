...
!77    format(x,'sfexch100',9f6.1,x,9f5.0,x,f6.1,x,9f6.1,x,f6.1,x,9f6.1, &
!     & x,f5.2,9f5.2)
...
21    format(x,'sfRADNET',i4,'z',f8.5,x,f8.5,x,f7.1,3f6.0)
22    format(x,'sfRHOKH',i4,'z',f8.5,x,f8.1,x,f5.1,x,f5.1,x,f6.5)
23    format(x,'sfFQW_1',i4,'z',f8.2,x,f8.2,x,f5.3,x,f4.0,x,f4.0)
24    format(x,'sfFTL_1',i4,'z',f8.3,x,f8.3,x,f5.3,x,f6.3,x,f6.2)
25    format(x,'sfZ0M',i4,'z',f8.5,x,f8.5,x,f5.2)
26    format(x,'sfTSTAR',i4,'z',f6.1,x,f6.1,x,f7.5,x,f7.0)
27    format(x,'sfCDCHt',i4,'z',f7.4,x,f7.4,x,f7.4,x,f7.4)
28    format(x,'sfTSOIL',i4,'z',10f6.1)
!
!
!     l=1000 has i=13,j=29
...
31    format(x,'sfRADNET',i4,'z',6f6.5,x,6f6.5,x,6f5.0,x,4f6.0)
32    format(x,'sfRHOKH',i4,'z',6f6.5,x,6f6.0,x,f5.1,x,f5.1,x,f6.5)
33    format(x,'sfFQW_1',i4,'z',f9.3,x,6f7.2,x,6f5.3,x,6f4.0,x,6f4.0)
34    format(x,'sfFTL_1',i4,'z',f8.3,x,6f6.1,x,f5.3,x,6f5.3,x,6f4.2)
35    format(x,'sfZ0M',i4,'z',6f7.5,x,6f7.5,x,6f4.2)
36    format(x,'sfTSTAR',i4,'z',f6.1,x,6f5.0,x,6f7.5,x,6f7.0)
37    format(x,'sfCDCHt',i4,'z',6f7.4,x,6f7.4,x,6f7.4,x,6f7.4)
38    format(x,'sfTSOIL,LAI',i4,'z',10f6.1,2x,5f4.2,x,5f4.2)
!     l=1500 has i=94,j=44
...
!               CANHC_TILE(l,:)
11    format(x,'sfRADNET',i4,'z',9f5.4,x,9f5.4,x,9f5.0)
12    format(x,'sfRHOKH',i4,'z',9f5.4,x,9f6.0,x,f5.1,x,f5.1,x,f6.5)
13    format(x,'sfFQW_1',i4,'z',f9.2,x,9f7.2,x,9f5.3,x,9f4.0,x,9f4.0)
14    format(x,'sfFTL_1',i4,'z',f8.3,x,9f5.0,x,f5.3,x,9f5.3,x,9f4.2)
15    format(x,'sfZ0M',i4,'z',9f7.5,x,9f7.5,x,9f4.2)
16    format(x,'sfTSTAR',i4,'z',f6.1,x,9f5.0,x,9f6.5,x,9f5.0)
      ENDIF
