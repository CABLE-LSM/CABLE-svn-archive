...
CONTAINS
  ...
  SUBROUTINE print_nlist_jules_surf_param()
    USE jules_print_mgr, ONLY : jules_print
    IMPLICIT NONE
    CHARACTER(LEN=50000) :: lineBuffer

    CALL jules_print('surf_param', &
        'Contents of namelist jules_surf_param')

    WRITE(lineBuffer,*)' hleaf = ',hleaf
    CALL jules_print('surf_param',lineBuffer)
  ...
  END SUBROUTINE print_nlist_jules_surf_param
