...
CONTAINS
  ...
  FUNCTION nf90_strerror(ncerr)
    ...
    WRITE(jules_message,*) 'FATAL ERROR: Attempt to use dummy NetCDF procedure'
    CALL jules_print('jules_netcdf_dummy',jules_message)
    WRITE(jules_message,*) 'To use NetCDF, recompile linking the NetCDF library'
    CALL jules_print('jules_netcdf_dummy',jules_message)
    STOP
