...
CONTAINS
  ...
  SUBROUTINE print_nlist_jules_nstypes()
    USE jules_print_mgr, ONLY : jules_print
    IMPLICIT NONE
    CHARACTER(LEN=50000) :: lineBuffer

    CALL jules_print('nstypes', &
        'Contents of namelist jules_nstypes')

    WRITE(lineBuffer,*)' npft = ',npft
    CALL jules_print('nstypes',lineBuffer)
  ...
  END SUBROUTINE print_nlist_jules_nstypes
