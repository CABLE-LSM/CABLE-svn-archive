...
#     else
      ...
      JTSOIL_TILE(3) = SI(303,Sect_No,im_index)
      JTSOIL_TILE(4) = SI(304,Sect_No,im_index)
      JSMCL_TILE(1) = SI(305,Sect_No,im_index)
      JSMCL_TILE(2) = SI(306,Sect_No,im_index)
      JSMCL_TILE(3) = SI(307,Sect_No,im_index)
      JSMCL_TILE(4) = SI(308,Sect_No,im_index)
      JSTHF_TILE(1) = SI(309,Sect_No,im_index)
      JSTHF_TILE(2) = SI(310,Sect_No,im_index)
      JSTHF_TILE(3) = SI(311,Sect_No,im_index)
      JSTHF_TILE(4) = SI(312,Sect_No,im_index)
      JSNOW_DEPTH3L(1) = SI(313,Sect_No,im_index)
      JSNOW_DEPTH3L(2) = SI(314,Sect_No,im_index)
      JSNOW_DEPTH3L(3) = SI(315,Sect_No,im_index)
      JSNOW_MASS3L(1) = SI(316,Sect_No,im_index)
      JSNOW_MASS3L(2) = SI(317,Sect_No,im_index)
      JSNOW_MASS3L(3) = SI(318,Sect_No,im_index)
#     endif

! Allow some user ancillaries just in case
...
!jhan{can use original 4 layer structure
...
#     ifdef CABLE_SOIL_LAYERS
      !--- jhan:replace spares w snow_vars
...
#else
      JUSER_MULT10(1) = SI(332,Sect_No,im_index)
