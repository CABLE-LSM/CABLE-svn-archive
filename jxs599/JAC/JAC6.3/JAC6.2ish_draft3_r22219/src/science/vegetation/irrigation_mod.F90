...
SUBROUTINE irrigation_control( a_step, land_pts, land_index,                   &
...
! Update irrigation every nstep_irrig timesteps
IF ( MOD(a_step, nstep_irrig) == 0 .AND. ( a_step > 1 ) ) THEN
