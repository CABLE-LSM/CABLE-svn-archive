...
! *****************************COPYRIGHT*******************************
MODULE cable_grid_update_implicit_mod
...
CHARACTER(LEN=*), PARAMETER, PRIVATE ::                                        &
                  ModuleName='CABLE_GRID_UPDATE_IMPLICIT_MOD'
...
!--------------------------------------------------------------------
!    Arguments :-
SUBROUTINE cable_grid_update_implicit (                                        &
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='CABLE_GRID_UPDATE_IMPLICIT'
...
RETURN
END SUBROUTINE cable_grid_update_implicit
END MODULE cable_grid_update_implicit_mod
