...
! *****************************COPYRIGHT*******************************
MODULE cable_griddiag_sf_implicit_mod
...
CONTAINS
!  SUBROUTINE CABLE_GRIDDIAG_SF_IMPLICIT ----------------------------
!
...
! IN sea/sea-ice data :
 ice_fract,ice_fract_cat_use,u_0,v_0,                                          &
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='CABLE_GRIDDIAG_SF_IMPLICIT'
...
RETURN
END SUBROUTINE cable_griddiag_sf_implicit
END MODULE cable_griddiag_sf_implicit_mod
