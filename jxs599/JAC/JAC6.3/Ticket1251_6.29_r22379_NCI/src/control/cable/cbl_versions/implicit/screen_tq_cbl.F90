...
! *****************************COPYRIGHT*******************************
MODULE screen_tq_mod_cbl

USE um_types, ONLY: real_jlslsm

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='SCREEN_TQ_MOD_CBL '
...
USE jules_surface_mod, ONLY: ip_scrndecpl2, ip_scrndecpl3,                     &
                              z_obs_wind, z_obs_tq, iscrntdiag

USE planet_constants_mod, ONLY: cp, grcp, g
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='SCREEN_TQ_CBL'
...
!$OMP DO SCHEDULE(STATIC)
  DO n = 1,nsurft
    !CABLE: avoid oversriting qip5m,t1p5m
