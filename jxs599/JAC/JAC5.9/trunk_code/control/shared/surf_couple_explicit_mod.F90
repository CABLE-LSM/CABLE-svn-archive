...
CASE ( jules )
  ...
  CALL jules_land_sf_explicit (                                               &
    ...
    psparms%catch_snow_surft, psparms%hcon_soilt,ho2r2_orog_gb,               &
    flandg(pdims%i_start:pdims%i_end,pdims%j_start:pdims%j_end),              &
    progs%snow_surft,sil_orog_land_gb,psparms%smvccl_soilt,                   &
    ...
    charnock_w,                                                               &
    !IN everything not covered so far :
    pstar,rhostar,lw_down,sw_surft,zh,ddmfx,                                  &
    ...
    lq_mix_bl,progs%t_soil_soilt,progs%tsurf_elev_surft,                      &
    tstar,progs%tstar_surft,z_land_ij,psparms%albsoil_soilt,psparms%cosz_ij,  &
  ...
  CALL jules_ssi_sf_explicit (                                                &
    ...
    charnock_w,                                                               &
    !IN everything not covered so far :
    pstar,rhostar,lw_down,zh,ddmfx,lq_mix_bl,progs%ti_sicat,                  &
    ainfo%ti_cat_sicat,                                                       &
    coast%tstar_sea_ij,coast%tstar_sice_sicat,z_land_ij,                      &
    ...
    sf_diag,                                                                  &
    !INOUT data :
    progs%z0msea_ij,fqw_1,ftl_1,t1_sd,q1_sd,cdr10m,                           &
    !OUT Diagnostic not requiring STASH flags :
  ...
  CALL jules_griddiag_sf_explicit (                                           &
    ...
    !IN soil/vegetation/land surface data :
    ainfo%land_index,nsurft,ho2r2_orog_gb,                                    &
    flandg(pdims%i_start:pdims%i_end,pdims%j_start:pdims%j_end),              &
    sil_orog_land_gb,                                                         &
    !IN everything not covered so far :
    pstar,rhostar,zh,tstar,l_aero_classic,                                    &
    !INOUT data :
    ...
    fb_surf,u_s,                                                              &
    !OUT data required elsewhere in boundary layer or surface code
    rhokh,h_blend_orog_ij,z0hssi,z0mssi,z0m_eff_ij,                           &
   !ancil_info (IN)
...
print *, "**Claire** print your LAI etc here"
