...
SUBROUTINE jules_surface_alloc(t_i_length,t_j_length)
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='JULES_SURFACE_ALLOC'

!End of header

IF (lhook) CALL dr_hook(ModuleName//':'//RoutineName,zhook_in,zhook_handle)

ALLOCATE( diff_frac(t_i_length * t_j_length))
diff_frac(:) = 0.0

IF (lhook) CALL dr_hook(ModuleName//':'//RoutineName,zhook_out,zhook_handle)
RETURN
END SUBROUTINE jules_surface_alloc
