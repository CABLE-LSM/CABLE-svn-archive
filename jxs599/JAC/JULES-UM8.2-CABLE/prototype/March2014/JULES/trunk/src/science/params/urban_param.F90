...
CONTAINS
  SUBROUTINE print_nlist_urban2t_param()
    USE jules_print_mgr, ONLY : jules_print
    IMPLICIT NONE
    CHARACTER(LEN=50000) :: lineBuffer

    CALL jules_print('urban_param', &
        'Contents of namelist urban2t_param')

#if defined(UM_JULES)
    WRITE(lineBuffer,*)' albsnc_c = ',albsnc_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' albsnc_rf = ',albsnc_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' albsnf_c = ',albsnf_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' albsnf_rf = ',albsnf_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' catch_c = ',catch_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' catch_rf = ',catch_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' gs_c = ',gs_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' gs_rf = ',gs_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' infil_c = ',infil_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' infil_rf = ',infil_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' z0_c = ',z0_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' z0_rf = ',z0_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' z0h_z0m_c = ',z0h_z0m_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' z0h_z0m_rf = ',z0h_z0m_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' ch_c = ',ch_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' ch_rf = ',ch_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' vf_c = ',vf_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' vf_rf = ',vf_rf
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' emis_c = ',emis_c
    CALL jules_print('urban_param',lineBuffer)
    WRITE(lineBuffer,*)' emis_rf = ',emis_rf
    CALL jules_print('urban_param',lineBuffer)
#endif
  ...
  END SUBROUTINE print_nlist_urban2t_param
