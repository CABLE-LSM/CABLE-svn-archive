...
CONTAINS
  ...
  SUBROUTINE print_nlist_jules_rad_param()
    USE jules_print_mgr, ONLY : jules_print
    IMPLICIT NONE
    CHARACTER(LEN=50000) :: lineBuffer

    CALL jules_print('rad_param', &
        'Contents of namelist jules_rad_param')

    WRITE(lineBuffer,*)' r0 = ',r0
    CALL jules_print('rad_param',lineBuffer)
  ...
  END SUBROUTINE print_nlist_jules_rad_param
