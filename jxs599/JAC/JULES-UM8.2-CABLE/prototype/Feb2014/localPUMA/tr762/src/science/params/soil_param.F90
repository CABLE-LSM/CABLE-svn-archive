...
CONTAINS
  SUBROUTINE print_nlist_jules_soil_param()
    USE jules_print_mgr, ONLY : jules_print
    IMPLICIT NONE
    CHARACTER(LEN=50000) :: lineBuffer

    CALL jules_print('soil_param', &
        'Contents of namelist jules_soil_param')

    WRITE(lineBuffer,*)' zsmc = ',zsmc
    CALL jules_print('soil_param',lineBuffer)
  ...
  END SUBROUTINE print_nlist_jules_soil_param
