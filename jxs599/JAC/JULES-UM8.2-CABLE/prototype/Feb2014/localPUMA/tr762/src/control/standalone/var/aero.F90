...
!                                    ! RHOSTAR*CD_STD*VSHR for CLASSIC aerosol scheme
  REAL, DIMENSION(:,:), ALLOCATABLE :: ARESIST
!                                    ! 1/(CD_STD*VSHR) for CLASSIC aerosol scheme
  REAL, DIMENSION(:,:), ALLOCATABLE :: RESIST_B
!                                    ! (1/CH-1/(CD_STD)/VSHR for CLASSIC aerosol scheme
  REAL, DIMENSION(:,:), ALLOCATABLE :: RHO_ARESIST_TILE
!                                    ! RHOSTAR*CD_STD*VSHR on land tiles for CLASSIC aerosol scheme
