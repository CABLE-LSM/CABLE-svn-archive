...
#if defined(UM_JULES)
USE land_surf_mod, ONLY:i_veg_vn,i_veg_vn_1b,i_veg_vn_2b
#endif
...
#if defined(UM_JULES)
!----------------------------------------------------------------------------
! set value of CONST_CH4 dependent upon whether running  1B or 2B veg scheme
! ideally this should set in future as a JULES input via namelist
! ---------------------------------------------------------------------------
IF (i_veg_vn == i_veg_vn_1b)  CONST_CH4        = 5.41E-12
IF (i_veg_vn == i_veg_vn_2b)  CONST_CH4        = 5.41E-10
#endif
