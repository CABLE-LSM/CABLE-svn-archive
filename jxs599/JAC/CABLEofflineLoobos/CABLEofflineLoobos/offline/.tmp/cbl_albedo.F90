...
real :: SumEffSurfRefl_beam(mp)
real :: SumEffSurfRefl_dif(mp)
integer :: i
integer,save ::rad_call =0 
integer :: cntile
...
call EffectiveSurfaceReflectance( EffSurfRefl_beam, EffSurfRefl_dif,           &
  ...
  SumEffSurfRefl_beam = EffSurfRefl_beam(:,1)
  vname='AlbEffSurfRefl_beam1'; dimx=mp  
  call cable_Pyfprintf( cDiag1, vname, SumEffSurfRefl_beam, dimx, .true.)
  
  SumEffSurfRefl_beam = EffSurfRefl_beam(:,2) 
  vname='AlbEffSurfRefl_beam2'; dimx=mp  
