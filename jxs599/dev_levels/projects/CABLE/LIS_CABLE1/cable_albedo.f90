...
! July 2012, C. Carouge : Add leaf reflectance and transmittance with veg
!                         type dependency.
...
CONTAINS
  ...
  SUBROUTINE surface_albedo(ssoil, veg, met, rad, canopy)
    ...
    REAL(r_1), DIMENSION(mp_patch,nrb) :: rhoch ! canopy reflection black horizontal leaves(6.19)
