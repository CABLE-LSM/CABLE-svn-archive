...
PROGRAM texttonc
  ...
  !======================================================================
  INTEGER, PARAMETER  :: mt = 43800   ! # met forcing timesteps      ! BP
  CHARACTER(LEN=*), PARAMETER :: filein = 'TumbaDataiia.csv'          ! BP
  CHARACTER(LEN=*), PARAMETER :: fileout = 'Tumbarumba2002-06.nc'    ! BP
  CHARACTER(LEN=33), PARAMETER :: timeunits= &
                                  & 'seconds since 2002-01-01 00:00:01' ! BP
  CHARACTER(LEN=33), PARAMETER :: timestpunits= &
                                  & 'timesteps since 2002-01-01 00:00:01'
