...
MODULE other_constants
  ...
  ! saturated soil albedos for 8 color classes and 2 wavebands (1=vis, 2=nir)
  real(r_1), PARAMETER, DIMENSION(8,nrb) :: albsat = (/ (/ 0.12,0.11,0.10,0.09,0.08,0.07,0.06,0.05 /), & 
                                                        (/ 0.24,0.22,0.20,0.18,0.16,0.14,0.12,0.10 /), &
                                                        (/ 0.,  0.,  0.,  0.,  0.,  0.,  0.,  0.   /) /) 

  ! dry soil albedos for 8 color classes and 2 wavebands (1=vis, 2=nir) 
  real(r_1), PARAMETER, DIMENSION(8,nrb) :: albdry = (/ (/0.24,0.22,0.20,0.18,0.16,0.14,0.12,0.10/), &
