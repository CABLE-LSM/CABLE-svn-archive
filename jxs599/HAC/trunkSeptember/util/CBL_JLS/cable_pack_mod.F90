...
!!H!these are per timestep forcing
...
!!
!!-----------------------------------------------------------------------------
!!H! the bean fraction is computed from within CABLE, per timestep, based on per
!!timestep forcing
...
USE cable_types_mod,          ONLY: mp, mstype, l_tile_pts
USE jules_surface_types_mod,  ONLY: ntype, ice
