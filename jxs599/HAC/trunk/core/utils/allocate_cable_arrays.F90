...
!CABLE_LSM: tiles soil prognostics to be initialized from IO
real, allocatable :: SoilTemp_CABLE(:,:,:)
real, allocatable :: SoilMoisture_CABLE(:,:,:)
real, allocatable :: FrozenSoilFrac_CABLE(:,:,:)
real, allocatable :: SnowDepth_CABLE(:,:,:)
real, allocatable :: SnowMass_CABLE(:,:,:)
real, allocatable :: SnowTemp_CABLE(:,:,:)
real, allocatable :: SnowDensity_CABLE(:,:,:)
real, allocatable :: ThreeLayerSnowFlag_CABLE(:,:)
real, allocatable :: OneLyrSnowDensity_CABLE(:,:)
real, allocatable :: SnowAge_CABLE(:,:)
...
ALLOCATE( SnowDepth_CABLE(land_pts, nsurft, nsmax), STAT=error )
  error_sum = error_sum + error

ALLOCATE( SnowMass_CABLE(land_pts,nsurft, nsmax),STAT=error )
  error_sum = error_sum + error

ALLOCATE( SnowTemp_CABLE(land_pts, nsurft, nsmax), STAT=error )
  error_sum = error_sum + error

ALLOCATE( SnowDensity_CABLE(land_pts,nsurft,nsmax),STAT=error)
  error_sum=error_sum+error
