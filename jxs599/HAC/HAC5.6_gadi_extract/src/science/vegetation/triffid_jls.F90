...
USE soil_biogeochem_utils_mod, ONLY:                                          &
  ! imported procedures
  soil_n_precalc

USE soil_inorg_n_mod, ONLY:                                                   &
  ! imported procedures
  soil_n_deposition, soil_n_fertiliser, soil_n_fixation, soil_n_uptake
...
USE trif_vars_mod, ONLY: cnsrv_veg_triffid_gb, cnsrv_soil_triffid_gb,         &
                         ...
                         n_fertiliser_pft, n_fertiliser_gb,                   &
...
CALL soil_n_precalc( land_pts, trif_pts, nstep_trif, trif_index,              &
                     ...
                     fert_layer, have_layers, dz, f_root_pft, isunfrozen )
