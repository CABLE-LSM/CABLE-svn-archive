...
REAL, INTENT(IN) :: var_land(land_pts)    ! input variable on land_pts
    
! Array arguments with intent(out)
REAL, INTENT(OUT) :: var_riv(riv_pts)     ! output variable on riv_pts
...
! Array arguments with intent(in)
REAL, INTENT(IN) :: var_riv(riv_pts)     ! input variable on riv_pts

! Array arguments with intent(out)
REAL, INTENT(OUT) :: var_land(land_pts)  ! output variable on land_pts
