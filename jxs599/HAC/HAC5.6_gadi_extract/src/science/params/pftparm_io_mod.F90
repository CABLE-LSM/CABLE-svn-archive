...
REAL ::                                                                       &
  a_wl_io(npft_max),                                                          &
  a_ws_io(npft_max),                                                          &
  act_jmax_io(npft_max),                                                      &
  act_vcmax_io(npft_max),                                                     &
  ...
  deact_jmax_io(npft_max),                                                    &
  deact_vcmax_io(npft_max),                                                   &
  dgl_dm_io(npft_max),                                                        &
  dgl_dt_io(npft_max),                                                        &
  dqcrit_io(npft_max),                                                        &
  ds_jmax_io(npft_max),                                                       &
  ds_vcmax_io(npft_max),                                                      &
  dz0v_dh_io(npft_max),                                                       &
  z0v_io(npft_max),                                                           &
  eta_sl_io(npft_max),                                                        &
  fd_io(npft_max),                                                            &
  ...
  fsmc_p0_io(npft_max),                                                       &
  f0_io(npft_max),                                                            &
  g1_stomata_io(npft_max),                                                    &
  g_leaf_0_io(npft_max),                                                      &
  glmin_io(npft_max),                                                         &
  infil_f_io(npft_max),                                                       &
  jv25_ratio_io(npft_max),                                                    &
  kext_io(npft_max),                                                          &
  kpar_io(npft_max),                                                          &
...
INTEGER, PARAMETER :: n_real = 94 * npft_max
...
TYPE my_namelist
  ...
  REAL :: act_jmax_io(npft_max)
  REAL :: act_vcmax_io(npft_max)
