...
MODULE write_module
  ...
  REAL,POINTER,DIMENSION(:,:) :: otmp2lt,otmp2xy,otmp2lp,&
  ...
  REAL,POINTER,DIMENSION(:,:,:,:) :: otmp4xypt,otmp4xyzt,otmp4xyst,&
       otmp4xysnt,otmp4xyrt,otmp4xypct,otmp4xysct,otmp4lpst,otmp4lpsnt, &
       otmp4lprt,otmp4lpsct,otmp4lppct,otmp4xyps,otmp4xyppc,otmp4xypsc, &
       otmp4xypr
...
CONTAINS
  ...
  SUBROUTINE define_output_variable_r1(ncid,varID,vname,&
    ...
    INTEGER, INTENT(IN) :: xID,yID,zID,landID,patchID,tID ! netcdf dimension IDs 
