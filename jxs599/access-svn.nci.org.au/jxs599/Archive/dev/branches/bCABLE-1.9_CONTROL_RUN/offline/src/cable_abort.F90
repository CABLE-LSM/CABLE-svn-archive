...
CONTAINS
  ...
  SUBROUTINE range_abort(message,ktau,met,value,var_range,i,xx,yy)
    ...
    INTEGER,INTENT(IN) :: i ! landpt number of erroneous grid square
    INTEGER,INTENT(IN),OPTIONAL:: xx ! coordinates of erroneous grid square
    INTEGER,INTENT(IN),OPTIONAL ::yy ! coordinates of erroneous grid square
