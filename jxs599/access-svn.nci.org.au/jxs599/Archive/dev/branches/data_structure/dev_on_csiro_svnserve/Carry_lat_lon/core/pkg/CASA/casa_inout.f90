...
SUBROUTINE casa_init(casabiome,casamet,casapool,casabal,veg)
...
!        READ(99,92) nyearz,npz,ivtz,istz,isoz,latz,lonz,areacellz,glaiz, &
        READ(99,92) nyearz,npz,ivtz,istz,isoz,latz,lonz,areacellz,casamet%glai(npt), &
...
!        READ(99,92) nyearz,npz,ivtz,istz,isoz,latz,lonz,areacellz,glaiz
      ...
      END SELECT 
!      PRINT *, 'npt,nyearz,npz,ivtz,istz,isoz,latz,lonz,glaiz:'
!      PRINT *, npt,nyearz,npz,ivtz,istz,isoz,latz,lonz,casamet%glai(npt)
    ENDDO
    CLOSE(99)
  ENDIF 
92  format(5(i6,3x),100(f15.6,3x))
PRINT *, 'Done reading initial pool sizes'
