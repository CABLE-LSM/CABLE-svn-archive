   ...
   subroutine initialize_soil( bexp, hcon, satcon, sathh, smvcst, smvcwt, &
      ...
      logical :: vegparmnew=.true., skip =.true. 
         ...
         if (first_call) then 
            ...
            !jhan
            ! **** Ask Jhan how to reorganise the code so at this stage we know 
            ! alreaayd vegetation types and we can use the following statement to initialize
            ! soil to isoilm = 9
...
!========================================================================
   ...
   subroutine initialize_radiation( sw_down, lw_down, cos_zenith_angle, &
      ...
      logical, save :: first_call= .true.
         ...
         !print *,'idjd1expl_bef',LS_RAIN(156,71)*1800.,LS_SNOW(156,71)*1800.
         !print *,'idjd2expl_bef',LS_RAIN(155,107)*1800.,LS_SNOW(155,107)*1800.
         !print *,'idjd3expl_bef',LS_RAIN(78,45)*1800.,LS_SNOW(78,45)*1800.
         ...
         !print *,'timestep',um1%TIMESTEP
         !print *,'idjd1expl_aft',LS_RAIN(156,71)*1800.,LS_SNOW(156,71)*1800.
         !print *,'idjd1exp2_aft',LS_RAIN(155,107)*1800.,LS_SNOW(155,107)*1800.
         !print *,'idjd1exp3_aft',LS_RAIN(78,45)*1800.,LS_SNOW(78,45)*1800.
   ...
   subroutine initialize_roughness( z1_tq, z1_uv, htveg )  
      ...
      real, allocatable, dimension(:,:) :: jhruff, jhwork
         ...
         DO l=1,um1%land_pts
           ...
           ENDDO
         ENDDO
         !jhan: huff is init. at beg. of cable_roughness anyway
