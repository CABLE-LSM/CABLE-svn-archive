...
MODULE io_variables
   ...
   USE define_dimensions, ONLY: r_2, mvtype, mstype
   ...
   INTEGER,DIMENSION(12) ::                                                    &
      ...
      lastday = (/31,59,90,120,151,181,212,243,273,304,334,365/),              &      lastdayl = (/31,60,91,121,152,182,213,244,274,305,335,366/)
