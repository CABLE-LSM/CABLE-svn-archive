...
!ESMM!%!USE cable_photo_constants_mod, ONLY : CGSW03 => GSW03
!ESMM!%!USE cable_photo_constants_mod, ONLY : CGSW04 => GSW04
!ESMM!%!USE cable_photo_constants_mod, ONLY : CCONKC0=> CONKC0
!ESMM!%!USE cable_photo_constants_mod, ONLY : CCONKO0=> CONKO0
!ESMM!%!USE cable_photo_constants_mod, ONLY : CEKC   => EKC
!ESMM!%!USE cable_photo_constants_mod, ONLY : CEKO   => EKO
!ESMM!%!USE cable_photo_constants_mod, ONLY : CD0C3   => D0C3
!ESMM!%!USE cable_photo_constants_mod, ONLY : CD0C4   => D0C4
!ESMM!%!USE cable_photo_constants_mod, ONLY : CA1C3   => A1C3
!ESMM!%!USE cable_photo_constants_mod, ONLY : CA1C4   => A1C4
!ESMM!%!USE cable_photo_constants_mod, ONLY : CALPHA3 => ALPHA3  
!ESMM!%!USE cable_photo_constants_mod, ONLY : CALPHA4 => ALPHA4  
!ESMM!%!USE cable_photo_constants_mod, ONLY : CCONVX3 => CONVX3
!ESMM!%!USE cable_photo_constants_mod, ONLY : CCONVX4 => CONVX4
...
sum_rad_gradis = SUM(rad%gradis,2)
      ...
      CALL wetLeaf( dels,                                 &
       ...
       !already done?sum_rad_gradis = SUM(rad%gradis,2)
