...
CONTAINS
  ...
  SUBROUTINE write_default_params(met,  air,    ssnow, veg, bgc,               &
    ...
    canopy%fnv     = 0.0
    canopy%fhv     = 0.0
    canopy%fwsoil = 1.0 ! vh ! should be calculated from soil moisture or be in restart file

    ssnow%kth = 0.3  ! vh ! should be calculated from soil moisture or be in restart file
    ssnow%sconds(:,:) = 0.06_r_2    ! vh ! snow thermal cond (W m-2 K-1), should be in restart file
