...
MODULE CABLE_canopy_main_module
   
   USE cable_data_module, ONLY : icanopy_type, point2constants 
   
   IMPLICIT NONE
   
   PUBLIC cable_canopy_main
   PRIVATE
...
SUBROUTINE cable_canopy_main(bal,rad,rough,air,met,dels,ssnow,soil,veg, canopy)
...
END SUBROUTINE cable_canopy_main
...
END MODULE CABLE_canopy_main_module
