...
build_build()
{
   ...
   /usr/bin/ar r libcableAF.a cable_explicit_driver.o cable_implicit_driver.o   \
   ...
   if [[ -f libcableAF.a ]]; then
      print '\nLibrary build successful. Copying libcableAF.a to ' $libroot
   else
      print '\nBuild failed\n'
      exit
   fi
...
export libpath=$libroot'/libcableAF.a'
