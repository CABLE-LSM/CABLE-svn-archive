...
# endif   
  ...
  REAL,  DIMENSION(tdims%i_end,tdims%j_end) :: latitude_deg, longitude_deg
...
call allocate_rad_albedo( mp, nrb )
  ...
  call cable_explicit_driver( row_length, rows, land_pts, ntiles,L_tile_pts,   &
                              npft, sm_levels, mp,nrb, timestep_width,         &
