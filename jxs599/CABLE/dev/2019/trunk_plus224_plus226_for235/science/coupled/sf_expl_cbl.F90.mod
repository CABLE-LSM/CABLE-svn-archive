...
! OUT data required elsewhere in boundary layer or surface code
 ...
 surft_index,surft_pts,tile_frac,fsmc_pft,emis_surft,emis_soil, fland,       &
!CABLE_LSM:{pass additional existing vars
!mype, timestep_number, endstep,                                               &
...
INTEGER :: mype, timestep_number, endstep
REAL :: fland(land_pts)
...
!C!  wt_ext_soilt,albsoil_soilt,cos_zenith_angle,                                &
...
CALL sf_exch_cbl (                                                                &
 ...
 !smvcst_soilt(:,1,1), smvcwt_soilt(:,1,1), smvccl_soilt(:,1,1),                & 
 !soil_alb, 
 surf_down_sw_cable, &!ls_rain_cable, ls_snow_cable,                   &
 !cosz_gb,                                                                      &
 !sin_theta_latitude,                                                           &
