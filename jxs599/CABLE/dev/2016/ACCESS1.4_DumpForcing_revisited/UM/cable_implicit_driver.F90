...
subroutine cable_implicit_driver( LS_RAIN, CON_RAIN, LS_SNOW, CONV_SNOW,       &
   ...
   integer, save :: iDiag0, iDiag1, iDiag2, iDiag3, iDiag4, iDiag5, iDiag6,   &
                    iDiag7, iDiag8, iDiag9, iDiag10, iDiag11, iDiag12, iDiag13 
...
!     !--- write all these fields,  cable_user%initialize_mapping can be
!     !--- set in namelist cable.nml
      ...
      if ( cable_user%initialize_mapping ) then
        ...
        call cable_diag( iDiag12, "radfbeam1_", mp, kend_gl, ktau_gl,knode_gl,      &
                           "radfbeam1", rad%fbeam(:,1) )

        call cable_diag( iDiag13, "radfbeam2_", mp, kend_gl, ktau_gl,knode_gl,      &
                           "radfbeam2", rad%fbeam(:,1) )
