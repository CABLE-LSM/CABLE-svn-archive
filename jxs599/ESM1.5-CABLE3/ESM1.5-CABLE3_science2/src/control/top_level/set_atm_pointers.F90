...
#     endif
      JPREV_YR_SFRAC   = SI(835,Sect_No,im_index)
...
! sect_no equals 0
      ...
      JWOOD_FLUX_C    =SI(895,Sect_No,im_index)  !
      JWOOD_FLUX_N    =SI(896,Sect_No,im_index)  !
      JWOOD_FLUX_P    =SI(897,Sect_No,im_index)  !
      JWOOD_HVEST_C(1)=SI(898,Sect_No,im_index)  !
      JWOOD_HVEST_C(2)=SI(899,Sect_No,im_index)  !
      JWOOD_HVEST_C(3)=SI(900,Sect_No,im_index)  !
      JWOOD_HVEST_N(1)=SI(901,Sect_No,im_index)  !
      JWOOD_HVEST_N(2)=SI(902,Sect_No,im_index)  !
      JWOOD_HVEST_N(3)=SI(903,Sect_No,im_index)  !
      JWOOD_HVEST_P(1)=SI(904,Sect_No,im_index)  !
      JWOOD_HVEST_P(2)=SI(905,Sect_No,im_index)  !
      JWOOD_HVEST_P(3)=SI(906,Sect_No,im_index)  !
      JTHINNING       =SI(916,Sect_No,im_index)  !
