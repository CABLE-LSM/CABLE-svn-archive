...
! Lestevens Sept 2012 - CASA-CNP
      ...
      real, pointer :: PREV_YR_SFRAC(:)
      real, pointer :: WOOD_HVEST_C(:)
      real, pointer :: WOOD_HVEST_N(:)
      real, pointer :: WOOD_HVEST_P(:)
      real, pointer :: WOOD_FLUX_C(:)
      real, pointer :: WOOD_FLUX_N(:)
      real, pointer :: WOOD_FLUX_P(:)
      real, pointer :: THINNING(:)
