...
! Lestevens Sept 2012 - CASA-CNP
     ...
     PHENPHASE   => D1(JPHENPHASE:JPHENPHASE+ &
                          field_length(land_points,no_halo,ntiles))
     PREV_YR_SFRAC => D1(JPREV_YR_SFRAC:JPREV_YR_SFRAC+ &
                          field_length(land_points,no_halo,ntiles))
     WOOD_HVEST_C => D1(JWOOD_HVEST_C(1):JWOOD_HVEST_C(1)+ &
                          field_length(land_points,no_halo,3*ntiles))
     WOOD_HVEST_N => D1(JWOOD_HVEST_N(1):JWOOD_HVEST_N(1)+ &
                          field_length(land_points,no_halo,3*ntiles))
     WOOD_HVEST_P => D1(JWOOD_HVEST_P(1):JWOOD_HVEST_P(1)+ &
                          field_length(land_points,no_halo,3*ntiles))
     WOOD_FLUX_C => D1(JWOOD_FLUX_C:JWOOD_FLUX_C+ &
                          field_length(land_points,no_halo,ntiles))
     WOOD_FLUX_N => D1(JWOOD_FLUX_N:JWOOD_FLUX_N+ &
                          field_length(land_points,no_halo,ntiles))
     WOOD_FLUX_P => D1(JWOOD_FLUX_P:JWOOD_FLUX_P+ &
                          field_length(land_points,no_halo,ntiles))
     THINNING => D1(JTHINNING:JTHINNING+ &
                          field_length(land_points,no_halo,ntiles))
