...
! kdcorbin, 02/10 - additions for output
      ...
      REAL field1out,field2out,field3out,drymassout,drymasstrop
...
! dry mass
            vert_int_array(I,J,ip_trop) =                                &
     &                    vert_int_array(i,j,ip_trop) + tempd
...
! DEPENDS ON: do_sums
     ...
     &             sum_results)
      ...
      drymasstrop=sum_results(ip_trop)*factor
