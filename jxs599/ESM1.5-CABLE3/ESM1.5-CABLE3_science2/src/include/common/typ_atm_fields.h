...
! Lestevens Sept 2012 - For CASA-CNP
      ...
      real :: PREV_YR_SFRAC(land_field,ntiles)
      real :: WOOD_HVEST_C(land_field,ntiles,3)
      real :: WOOD_HVEST_N(land_field,ntiles,3)
      real :: WOOD_HVEST_P(land_field,ntiles,3)
      real :: WOOD_FLUX_C(land_field,ntiles)
      real :: WOOD_FLUX_N(land_field,ntiles)
      real :: WOOD_FLUX_P(land_field,ntiles)
      real :: THINNING(land_field,ntiles)
