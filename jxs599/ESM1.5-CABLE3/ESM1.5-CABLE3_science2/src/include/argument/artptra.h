...
! CABLE and CASA-CNP - Lest Sept 2012
...
A_SPPTR(A_IXPTR(185)),A_SPPTR(A_IXPTR(186)),A_SPPTR(A_IXPTR(187)),&
A_SPPTR(A_IXPTR(188)),A_SPPTR(A_IXPTR(189)),A_SPPTR(A_IXPTR(190)),&
A_SPPTR(A_IXPTR(191)),&
#endif
