...
! Fossil-fuel organic carbon aerosol
     &  JOCFF_NEW, JOCFF_AGD, JOCFF_CLD,                                &
      ! CABLE
!     &  JTSOIL_TILE, JSMCL_TILE, JSTHU_TILE, JSTHF_TILE, JSNOW_DEPTH3L, &
...
! Lestevens Sept 2012 - adding new progs
     ...
     &  JNIDEP,JNIFIX,JPWEA,JPDUST,JGLAI,JPHENPHASE,JPREV_YR_SFRAC,     &
     &  JWOOD_HVEST_C,JWOOD_HVEST_N,JWOOD_HVEST_P,                      &
     &  JWOOD_FLUX_C,JWOOD_FLUX_N,JWOOD_FLUX_P,JTHINNING,               &
! ARGPTRA end
#endif
