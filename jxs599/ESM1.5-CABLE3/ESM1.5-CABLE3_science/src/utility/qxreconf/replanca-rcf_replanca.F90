...
!L Loop over ancillary fields(atmosphere)
      ...
      Do irec=1,ancRecs
        ...
        !print *,'lest field',stashancil(irec),irec,stashancil(field),field
...
! Lestevens 26sep17 - testing LUC
       IF (FIELD == 83)  LINTERPOLATE=.FALSE.
       IF (FIELD == 48)  LINTERPOLATE=.FALSE.
...
!Tracer Fluxes - kdcorbin, 04/10, 08/18 lstevens - ndep
