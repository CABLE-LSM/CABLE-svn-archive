...
!atmos_physics2 needs:
      ...
      WB_LAKE,FNSNET,FNLEACH,FNUP,FNLOSS,FNDEP,FNFIX
...
!pfu MOD
      ...
      ALLOCATE(WRESP_C(LAND_POINTS,NTILES,3))
      ALLOCATE(WRESP_N(LAND_POINTS,NTILES,3))
      ALLOCATE(WRESP_P(LAND_POINTS,NTILES,3))
      ALLOCATE(WB_LAKE(LAND_POINTS,NTILES))
      ALLOCATE(FNSNET(LAND_POINTS,NTILES))
      ALLOCATE(FNLEACH(LAND_POINTS,NTILES))
      ALLOCATE(FNUP(LAND_POINTS,NTILES))
      ALLOCATE(FNLOSS(LAND_POINTS,NTILES))
      ALLOCATE(FNDEP(LAND_POINTS,NTILES))
      ALLOCATE(FNFIX(LAND_POINTS,NTILES))
...
! Lestevens - need first_atmstep_call for wblake fix
     ...
     !&, NIDEP,NIFIX,PWEA,PDUST,GLAI,PHENPHASE,USER_ANC1                 &
