...
!!!      A_IXPTR(166)=A_IXPTR(165) + SM_LEVELS          ! jsthu_tile 
      ...
      A_IXPTR(174)=A_IXPTR(173) + 1                  ! jprev_yr_sfrac 
! Lestevens Sept 2012 - adding new prognostics
      A_IXPTR(175)=A_IXPTR(174) + 10                 ! jcpool_tile
      A_IXPTR(176)=A_IXPTR(175) + 10                 ! jnpool_tile
      A_IXPTR(177)=A_IXPTR(176) + 12                 ! jppool_tile
      A_IXPTR(178)=A_IXPTR(177) + 1                  ! jsoil_order
      A_IXPTR(179)=A_IXPTR(178) + 1                  ! jnidep
      A_IXPTR(180)=A_IXPTR(179) + 1                  ! jnifix
      A_IXPTR(181)=A_IXPTR(180) + 1                  ! jpwea
      A_IXPTR(182)=A_IXPTR(181) + 1                  ! jpdust
      A_IXPTR(183)=A_IXPTR(182) + 1                  ! jglai
      A_IXPTR(184)=A_IXPTR(183) + 1                  ! jphenphase
      A_IXPTR(185)=A_IXPTR(184) + 1                  ! jwood_flux
      A_IXPTR(186)=A_IXPTR(185) + 1                  ! jwood_flux
      A_IXPTR(187)=A_IXPTR(186) + 1                  ! jwood_flux
      A_IXPTR(188)=A_IXPTR(187) + 3                  ! jwood_hvest
      A_IXPTR(189)=A_IXPTR(188) + 3                  ! jwood_hvest
      A_IXPTR(190)=A_IXPTR(189) + 3                  ! jwood_hvest
      A_IXPTR(191)=A_IXPTR(190) + 1                  ! jthinning

!     Super array length. If length of last variable could be zero, use
!     max(nlevs,1) to avoid out of bounds warning messages

! Lestevens Sept 2012 - increase length of A_SPPTR_LEN
      !A_SPPTR_LEN  =A_IXPTR(173) + MODEL_LEVELS
      A_SPPTR_LEN  =A_IXPTR(191) + MODEL_LEVELS
