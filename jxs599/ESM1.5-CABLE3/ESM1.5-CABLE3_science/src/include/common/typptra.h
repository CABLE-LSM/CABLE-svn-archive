...
! Lestevens Sept 2012 - adding new progs for CASA-CNP
      ...
      INTEGER :: JGLAI
      INTEGER :: JPHENPHASE
      INTEGER :: JPREV_YR_SFRAC
      INTEGER :: JWOOD_HVEST_C(3)
      INTEGER :: JWOOD_HVEST_N(3)
      INTEGER :: JWOOD_HVEST_P(3)
      INTEGER :: JWOOD_FLUX_C
      INTEGER :: JWOOD_FLUX_N
      INTEGER :: JWOOD_FLUX_P
      INTEGER :: JTHINNING
