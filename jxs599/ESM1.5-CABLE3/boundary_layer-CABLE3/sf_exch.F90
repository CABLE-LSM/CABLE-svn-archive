...
! Lestevens Sept2012: CasaCNP variables 
     ...
     &, PREV_YR_SFRAC(land_pts,NTILES)                           &
     &,WOOD_HVEST_C(land_pts,NTILES,3)                           &
     &,WOOD_HVEST_N(land_pts,NTILES,3)                           &
     &,WOOD_HVEST_P(land_pts,NTILES,3)                           &
     &,WRESP_C(land_pts,NTILES,3)                                &
     &,WRESP_N(land_pts,NTILES,3)                                &
     &,WRESP_P(land_pts,NTILES,3)                                &
     &,WOOD_FLUX_C(land_pts,NTILES)                              &
     &,WOOD_FLUX_N(land_pts,NTILES)                              &
     &,WOOD_FLUX_P(land_pts,NTILES)                              &
     &,THINNING(land_pts,NTILES)                                 &
...
! rml 2/7/13 pass 3d co2 through to cable if required
                   ...
                   WRESP_C,WRESP_N,WRESP_P, THINNING,                   &
     ! Lestevens 23apr13 / TZ 05/12/18
                   NPP_FT_ACC,RESP_W_FT_ACC,RESP_S_ACC,iday_number,                          &
                   ! end step of experiment, this step, step width, processor num
                   endstep, timestep_number, mype &
                 & )
      endif
