...
! Lestevens Sept2012: CasaCNP variables 
     ...
     &, FNSNET(land_pts,NTILES) &
     &, FNLEACH(land_pts,NTILES) &
     &, FNUP(land_pts,NTILES) &
     &, FNLOSS(land_pts,NTILES) & 
     &, FNDEP(land_pts,NTILES) &
     &, FNFIX(land_pts,NTILES)
