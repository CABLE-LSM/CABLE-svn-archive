...
MODULE oasis3_atm_data_mod
  ...
  ! is no good for that.
  DATA vind_ocn_freezen    /31,32,33,34,35/
  DATA vind_ocn_snowthickn /41,42,43,44,45/
  DATA vind_ocn_hicen      /51,52,53,54,55/
  DATA vind_topmeltn       /61,62,63,64,65/
  DATA vind_botmeltn       /71,72,73,74,75/
