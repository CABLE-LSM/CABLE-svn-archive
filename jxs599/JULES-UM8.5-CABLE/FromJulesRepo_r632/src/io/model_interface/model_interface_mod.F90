...
! Variable ids
  INTEGER, PARAMETER ::                                                       &
    ...
    var_id_albobs_sw       = var_id_albsoil + 1,                              &
    var_id_albobs_vis      = var_id_albobs_sw + 1,                           &
    var_id_albobs_nir      = var_id_albobs_vis + 1,                          &
    var_id_b               = var_id_albobs_nir + 1,                           &
    ...
    var_id_snow_ice        = var_id_snow_ds + 1,                              &
    var_id_snow_liq        = var_id_snow_ice + 1,                             &
    var_id_tsnow           = var_id_snow_liq + 1,                             &
    var_id_rgrainl         = var_id_tsnow + 1,                                &
    var_id_pstar           = var_id_rgrainl + 1,                              &
    ...
    var_id_snow_grnd_gb    = var_id_snow_frac + 1,                            &
...
! Parameters
    IDENTIFIER_LEN,                                                           &
    PFT_DIM_NAME_OUT, NVG_DIM_NAME_OUT, TYPE_DIM_NAME_OUT, TILE_DIM_NAME_OUT, &
    SNOW_DIM_NAME_OUT, SOIL_DIM_NAME_OUT, SCPOOL_DIM_NAME_OUT,                &
! Variables
    pft_dim_name, nvg_dim_name, type_dim_name, tile_dim_name, snow_dim_name,  &
    soil_dim_name, scpool_dim_name,                                           &
    pft_dim_size, nvg_dim_size, type_dim_size, tile_dim_size, snow_dim_size,  &
