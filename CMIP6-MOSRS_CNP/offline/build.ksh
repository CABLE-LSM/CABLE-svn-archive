...
known_hosts()
{
   set -A kh  pear jigg nXXX raij ces2 ccrc mael ccrc ccrc Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart ccrc
host_ccrc(){
...
host_write()
{
   ...
   print '{' >> junk
   print '   set -A kh' ${kh[*]} $HOST_MACH >> junk ccrc ccrc Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart Mart ccrc
   print '}' >> junk
   print '' >> junk
   print '' >> junk
