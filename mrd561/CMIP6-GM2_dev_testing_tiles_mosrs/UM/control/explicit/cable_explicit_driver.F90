...
integer ::  i,j
  ...
  write (6, *)  "line 316 explicit"
  write(6,*) 'rho ice is ',rho_ice
  write(6,*) 'rho liq is ',rho_water
  ...
  !fprintf_____________________________________________________________________} 
   ...
   IF(first_cable_call) THEN
      !write(6,*) 'calling um_runtime vars'
      CALL cable_um_runtime_vars(runtime_vars_file) 
      !write(6,*) 'called um_runtime vars'
   ...
   !--- down from UM.                                                 ---! 
   !---------------------------------------------------------------------!
   !write(6,*) 'calling interface_UM_data'
