...
PROGRAM cable_offline_driver
  ...
  LOGICAL, SAVE              :: &
    ...
    GPPconv  = .FALSE.,         & ! has GPP converged in CABLE + CASA-CNP?
...
!      GPPconv = .FALSE.
!    ELSE
!      PRINT *, 'Warning: Spin up CASA-CNP require spin up of CABLE GPP.'
!      PRINT *, '         Please change your spinup switch unless you'
!      PRINT *, '         already have a good enough poolsize file.'
!      WRITE(logn, *) 'Warning: Spin up CASA-CNP require spin up of CABLE GPP.'
!      WRITE(logn, *) '         Please change your spinup switch unless you'
!      WRITE(logn, *) '         already have a good enough poolsize file.'
!      spinConv = .TRUE.
!      GPPconv = .TRUE.
!    ENDIF
!  ELSE
