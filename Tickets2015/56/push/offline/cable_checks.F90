...
!
   ...
   TYPE ranges_type 
      REAL, DIMENSION(2) ::                                               &
           ...
           g0c3 = (/-0.5,0.5/),      & ! Ticket #56 (must find better range)
           g0c4 = (/-0.5,0.5/),      & ! Ticket #56 (must find better range)
           g1c3 = (/0.0,20.0/),      & ! Ticket #56 (must find better range)
           g1c4 = (/0.0,20.0/),      & ! Ticket #56 (must find better range)
           xalbnir = (/0.0,1.5/),              &
           meth = (/0.0,1.0/),                 &
           za =(/0.0,150.0/),                  &
           rpcoef = (/0.05,1.5/),              &
