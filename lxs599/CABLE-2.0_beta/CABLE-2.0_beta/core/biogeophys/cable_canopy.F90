   ...
   DO WHILE (k < C%MAXITER)
      ...
      DO i=1,mp
         ...
         IF (canopy%vlaiw(i) > C%LAI_THRESH .AND. abs_deltlf(i) > 0.1) THEN
            ...
            !fwsoil_coef(i) = fwsoil(i)**0.2
            !vx3(i,1)  = ej3x(temp2(i,1),ejmxt3(i,1))*fwsoil_coef(i)
            !vx3(i,2)  = ej3x(temp2(i,2),ejmxt3(i,2))*fwsoil_coef(i)
            ...
            !vx4(i,1)  = ej4x(temp2(i,1),vcmxt4(i,1))*fwsoil_coef(i)
            !vx4(i,2)  = ej4x(temp2(i,2),vcmxt4(i,2))*fwsoil_coef(i)
